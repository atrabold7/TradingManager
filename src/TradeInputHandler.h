...
public:
    ...
    std::optional<float> readFloat(const std::string &command);
    ...
    void displayPerformanceReport(float totalGrossWin, float totalFee, float totalTax, float totalNetWin);
